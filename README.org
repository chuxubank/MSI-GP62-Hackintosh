...
3. If you can't get video output on 4K displayer, you should wait for the system completed booted and make the internal screen black once(you can use hotcorner to "Put Display to Sleep"), and then you can plugin the cable and the external displayer will work.
** Notes
